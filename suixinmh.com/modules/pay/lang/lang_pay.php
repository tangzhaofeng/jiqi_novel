...
$jieqiLang['pay']['need_login']='对不起，必须注册成为本站会员并登陆才能使用本功能！<br /><br /><a href="/login'.(empty($_SERVER['HTTP_REFERER'])?'':'?jumpurl='.urlencode($_SERVER['HTTP_REFERER'])).'">用户登录</a> &nbsp;&nbsp; <a href="/register'.(empty($_SERVER['HTTP_REFERER'])?'':'?jumpurl='.urlencode($_SERVER['HTTP_REFERER'])).'">注册新用户</a>';
...
$jieqiLang['pay']['pay_failure_message']='对不起，交易失败！';
?>