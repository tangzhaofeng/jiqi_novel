...
class qqloginController extends chief_controller { 

	public $theme_dir = false;
	public $template_name = 'bindlogin';
	public $appid = '101305491';
	public $appkey = '7665e65d63c736bbc759aeec05fecdfd';
	public $callback = API_URL;
	public $caching = false;
	
	public function main($params = array()){
		$dataObj = $this->model('qqlogin','system','connect');  
