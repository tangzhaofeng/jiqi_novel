<table cellpadding="0" cellspacing="0" class="grid">
			<tr> 
			  <th>默认模板列表</th>
			  <td><textarea name="setting[items]" rows="2" cols="20" id="items" style="height:100px;width:280px;"><?=$items?></textarea><br>格式：模板路径|模板名称<p><span style="color:#ff0000">默认放在 /modules/news/templates/default/ 目录下</span></td>
			</tr>
			<tr> 
			  <th>高度</th>
