...
<?php echo $v['tag']?>：<span id="load_<?=$this->field?>_<?=$k?>"><a href="javascript:get<?=$this->field?>Data('load_<?=$this->field?>_<?=$k?>',<?php echo $v['id']?>,1);" id="click_<?=$this->field?>_<?php echo $v['id']?>_<?=$k?>">获取数据</a></span><br>
<?php }?>
...
$("a[id*='click_<?=$this->field?>_']").each(function(id){
     var ids = this.id;
	 var t = ids.split('_');
	 get<?=$this->field?>Data('load_<?=$this->field?>_'+t[3],t[2],1);
});
</script>
