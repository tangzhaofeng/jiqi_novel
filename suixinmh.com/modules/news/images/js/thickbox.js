...
var tb_pathToImage = "/modules/news/images/loadingAnimation.gif";
var overlayclickclose = overlayclickclose ? overlayclickclose :false;//点击窗体遮照是否关闭层
	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if (document.getElementById("TB_HideSelect") === null) {//iframe to hide select elements in ie6
				...
				if(overlayclickclose) $("#TB_overlay").click(tb_remove);
			}
		}else{//all others
