...
$jieqiLang['article']['collect_exists_note']='经检测，文章《%s》已经存在！<br /><a href="%s">点击这里自动检查更新</a><br /><a href="%s">点击这里返回文章信息页面</a>';
$jieqiLang['article']['collect_article_notsite']='文章《%s》非本站点所属，将不会自动采集！';
...
$jieqiLang['article']['parse_articletitle_failure']='文章标题解析失败，可能是采集规则错误或者对方网站暂时无法打开！<br />URL=%s<hr>%s<br />';
...
$jieqiLang['article']['rule_send_wget']='调用wget命令，用于突破防采集设置';
$jieqiLang['article']['rule_sendwget_note']='开启exec函数才能启用此功能；windows主机需将wget组件安装到c:/windows目录。此设置将覆盖代理采集配置！';
$jieqiLang['article']['rule_make_set']='采集时生成';
$jieqiLang['article']['rule_makeset_note']='批量采集时,设置此项可以加快采集速度！';
...
$jieqiLang['article']['rule_article_typeid']='文章子类型采集规则';
$jieqiLang['article']['rule_typeid_relation']='文章子类型对应关系';
$jieqiLang['article']['rule_typeid_note']='对方子类名称和本站类型序号用“=”分割，两个子类之间用“,”分割，子类名称用“default”标识默认的类型对应关系。格式：对方大类名称=>对方子类名称=[对应本站大类ID|]对应本站小类ID,...||对方大类名称=>...';
$jieqiLang['article']['rule_typeid_guide']='<br />本站子类型和子序号对应关系如下：<br />%s';
...
$jieqiLang['article']['collect_no_update']='已经检测完成，没有发现更新章节！<br /><a href="%s">点击这里查看文章信息</a><br /><a href="%s">点击这里清空文章并重新采集</a><br /><a href="%s">点击这里采集其他文章</a>';
$jieqiLang['article']['collect_cant_update']='已经检测完成，发现《%s》有新章节(<b>更新于:</b>%s;<b>出自</b>:%s)，但是和现有章节不对应，无法继续采集，不对应章节如下：<br />%s<br /><a href="%s" target=_blank>点击这里进入文章管理</a><br /><a href="%s" target=_blank>点击这里清空文章并重新采集</a><br /><a href="%s">点击这里采集其他文章</a>';
$jieqiLang['article']['collect_cant_update_noformsite']='已经检测完成，发现有新章节，但是和现有章节不对应，无法继续采集，不对应章节如下：<br />%s<br /><a href="%s">点击这里进入文章管理</a><br /><a href="%s">点击这里清空文章并重新采集</a><br /><a href="%s">点击这里采集其他文章</a>';
//include/collectarticle.php
$jieqiLang['article']['article_collect_clean']='文章《%s》现有的章节结构无法和对方文章结构相对应，已被清空并准备重新采集<br />';
$jieqiLang['article']['collect_chapter_doing']='正在采集《%s》共有 %s 个章节需要采集，采集时间与章节数量和对方网站打开速度有关，请耐心等待.....<br>';
