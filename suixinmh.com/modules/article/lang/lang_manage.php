...
$jieqiLang['article']['top_dayflower']='鲜花日排行';
$jieqiLang['article']['top_weekflower']='鲜花周排行';
$jieqiLang['article']['top_monthflower']='鲜花月排行';
$jieqiLang['article']['top_allflower']='鲜花总排行';

$jieqiLang['article']['top_vipvote']='情书月排行';
$jieqiLang['article']['top_vipvotepre']='情书上月排行';
$jieqiLang['article']['top_signnew']='最新签约';
...
//admin/reviewforbidls.php
$jieqiLang['article']['review_who']='您';
$jieqiLang['article']['review_indays']='天内';
$jieqiLang['article']['review_forbid']='%s书评禁言';
$jieqiLang['article']['review_forbid_list']='%s书评禁言列表';
$jieqiLang['article']['review_forbid_uid']='被禁言用户';
$jieqiLang['article']['review_forbid_uid_description']='用户将不能在本书发书评 <a href="'.JIEQI_URL.'/newmessage.php" target="_blank">发短信通知对方</a>';
$jieqiLang['article']['review_forbid_days']='被本书禁言天数';
$jieqiLang['article']['review_forbid_days_description']='请输入数字，留空或0则永远禁言';
$jieqiLang['article']['review_forbid_days_nonumeric']='禁言天数为一个大于0的数字!';
$jieqiLang['article']['review_forbid_success']='%s己被%s管理员禁止%s在书评区发言!';
$jieqiLang['article']['review_unforbid_success']='%s己被%s管理员充许在书评区发言!';
$jieqiLang['article']['review_forbid_error']='数据处理失败，请联系管理员!';
$jieqiLang['article']['review_forbid_messagetitle']='系统提示！';
?>