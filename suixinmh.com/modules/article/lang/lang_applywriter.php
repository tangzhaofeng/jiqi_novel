...
//applywriter.php
$jieqiLang['article']['has_been_writer']='您已经拥有发表文章的权利，系统将自动跳转到作家专区。<br /><br /><a href="%s">点击这里直接进入作家专区</a><script language="javascript">setTimeout(function(){document.location="%s";}, 2000);</script>';
$jieqiLang['article']['no_writer_group']='对不起，您申请的用户类型不存在！';
$jieqiLang['article']['no_writer_admin']='对不起，不允许升级为管理员！';
$jieqiLang['article']['need_simple_chapter']='对不起，请提交文章样章！';
