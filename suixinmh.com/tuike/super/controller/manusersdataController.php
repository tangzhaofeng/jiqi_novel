<?php
  ...
  class manusersdataController extends Tuike_controller {
  ...
  public function main($params = array()) {
    ...
    $dataObj=$this->model('manusersdata');
    $params['page']=1;
    $params['limit']=20;
    $data['ktList']=$dataObj->maUserData($params);
    $data['page']=$dataObj->getPage($this->getUrl(JIEQI_MODULE_NAME,'manusersdata','evalpage=0'));

    $this->display($data,'manusersdata_list');
  }
