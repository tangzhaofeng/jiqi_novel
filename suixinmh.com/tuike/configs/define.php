<?php
@define('JIEQI_URL','http://test.yun.ishufun.net');
@define('YOUYUEBOOK_URL','http://test.yun.ishufun.net');
@define('YOUYUEBOOK_URL_M','http://yun.mmd6666.com');

@define('JIEQI_SITE_NAME','优阅云');
...
@define('JIEQI_DB_PASS','48226x3433zyNQZ1');
@define('JIEQI_DB_NAME','tuike');
...
@define('JIEQI_BOTTOM_BAR','<a href="" target="_blank" style="color:#FFFFFF">粤ICP备16032081号-1</a> 广州九跃网络科技有限公司版权所有');
...
@define('JIEQI_REDIS_HOST','localhost');
...
@define('JIEQI_COOKIE_DOMAIN','test.yun.ishufun.net'); 
...
$GLOBALS['GLO_PAYLOG_PAY_TYPE']=array(
