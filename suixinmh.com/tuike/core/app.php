...
defined('HLM_URL_TYPE') or define('HLM_URL_TYPE', '2');
...
if ( !isset($jieqiTpl) || !is_object($jieqiTpl)) include_once JIEQI_ROOT_PATH .'/'. JIEQI_MODULE_NAME.'/header.php';
...
final class Application extends JieqiObject
{
    ...
    public static $DU_CONTROLLER = NULL;
    public static $DU_METHOD = NULL;
...
// die();
        ...
        self::$DU_CONTROLLER=$controller;
        self::$DU_METHOD=$method;
