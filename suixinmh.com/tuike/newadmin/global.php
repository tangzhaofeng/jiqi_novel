...
if(!defined('JIEQI_ROOT_PATH')) @define('JIEQI_ROOT_PATH', str_replace(array('\\\\', '\\'), '/',dirname( dirname( dirname(__FILE__) ))));
if(!defined('JIEQI_ROOT_PATH_APP'))define('JIEQI_ROOT_PATH_APP', JIEQI_ROOT_PATH.'/tuike/'.JIEQI_MODULE_NAME);
...
{
    if ($uid == -1) $uid = '';
    else $uid = $uid ? $uid : (isset($_SESSION['jieqiUserId'])?$_SESSION['jieqiUserId']:'');
