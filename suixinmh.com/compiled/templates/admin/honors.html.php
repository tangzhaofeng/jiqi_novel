...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
  <tr>
    <td class="odd" align="center">'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['honorid'].'</td>
	<td class="odd" align="center">'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['photo'].'</td>
    <td class="even" align="center">'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['caption'].'</td>
    <td class="odd" align="left">'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['minscore'].'</td>
	<td class="odd" align="left">'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['maxscore'].'</td>
    <td class="even" align="center"><a href="'.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['url_edit'].'">编辑</a>';
if($this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['honortype'] == 0){
echo '  <a href="javascript:if(confirm(\'确实要删除该头衔么？\')) document.location=\''.$this->_tpl_vars['honors'][$this->_tpl_vars['i']['key']]['url_del'].'\';">删除</a>';
}
echo '</td>
  </tr>
  ';
