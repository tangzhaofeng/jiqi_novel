...
<div id="tops">
  ...
  <div id="nav_right">      
    <a href="'.$this->_tpl_vars['jieqi_licenseurl'].'" target="mainframe">授权信息</a> 
  </div>
...
<li class="l_ts"><a href="#" onClick="return false;">帮助</a>
  <ul  class="l_tu">
	<li><a href="'.$this->_tpl_vars['jieqi_licenseurl'].'" target="mainframe">授权信息</a></li>
  </ul>
</li>
	</ul>			
<div id="nav_bg_r"></div>
	...
	<div id="banben">
	<a href="'.$this->_tpl_vars['jieqi_url'].'/">'.$this->_tpl_vars['jieqi_sitename'].' '.$this->_tpl_vars['jieqi_version'].' '.$this->_tpl_vars['jieqi_vtype'].'</a>
	<a href="'.geturl('system','userhub','SYS=method=logout').'" target="_top">[退出系统]</a>
	</div>        
    </div>
</td></tr>
