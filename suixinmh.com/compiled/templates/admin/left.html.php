...
<script type="text/javascript" src="'.$this->_tpl_vars['jieqi_url'].'/lib/html/fckeditor/jquery.min111.js"></script>
...
<div class=block>
	...
	<div class="content_w">
		<div class="blocktitle"><a class="title_link" href="'.$this->_tpl_vars['jieqi_url'].'/" target="_blank">网站首页</a>&nbsp;<a class="title_link" href="'.$this->_tpl_vars['jieqi_adminurl'].'" target="mainframe">后台首页</a></div>
	</div>
...
echo '
		';
if($this->_tpl_vars['adminmenus'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['ajaxurl']!=''){
echo '
		<li><a href="javascript:void(0);" onClick="showsubmenu(\'kk_'.$this->_tpl_vars['j']['key'].'\')" target="mainframe">'.$this->_tpl_vars['adminmenus'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['caption'].'</a></li>
		<li id="kk_'.$this->_tpl_vars['j']['key'].'" name="kk_'.$this->_tpl_vars['j']['key'].'"><IFRAME id="k_mod_'.$this->_tpl_vars['i']['key'].'" name="k_mod_'.$this->_tpl_vars['i']['key'].'" width="140px;" SRC="'.$this->_tpl_vars['adminmenus'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['ajaxurl'].'" FRAMEBORDER="0" scrolling="no"></IFRAME> </li>
		';
}else{
echo '
