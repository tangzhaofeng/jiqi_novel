...
echo '</td>
    <td class="odd"><a href="'.$this->_tpl_vars['jieqi_url'].'/web_admin/?controller=messagedetail&id='.$this->_tpl_vars['messagerows'][$this->_tpl_vars['i']['key']]['messageid'].'">'.$this->_tpl_vars['messagerows'][$this->_tpl_vars['i']['key']]['title'].'</a></td>
