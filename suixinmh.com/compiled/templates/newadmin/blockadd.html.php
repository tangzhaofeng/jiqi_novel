				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>添加强制关注卡点
							</div>
						</div>
						<div class="portlet-body">
                            <form action="index.php?controller=article&method=addblock&type=post" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div>
                                                <input data-type="number" class="form-control form-control-inline input-large date-picker"
                                                       size="10" type="text" name="articleid" value="'.$this->_tpl_vars['articleid'].'"/>
                                            </div>
                                        </div>
										<div class="col-md-12">
											<h3>
											...
											<div>
												<input data-type="number" class="form-control form-control-inline input-large date-picker"
													   size="10" type="text" name="chapterid" value="'.$this->_tpl_vars['chapterid'].'"/>
											</div>
										</div>
										<div class="col-md-12">
											<h3>
