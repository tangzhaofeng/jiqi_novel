				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<form action="index.php?controller=userlist&method=edit" method="post">
								...
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-12">
											...
											<div>
												<input disabled="disabled" class="form-control form-control-inline input-large date-picker"
...
echo ' class="form-control form-control-inline input-large date-picker"
...
echo '  data-type="number" class="form-control form-control-inline input-large date-picker"
