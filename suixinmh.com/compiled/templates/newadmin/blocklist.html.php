                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-globe"></i>小说强制关注设置
                            </div>
                            <button id="sample_editable_1_new" class="btn green" onclick="document.location.href=\'index.php?controller=article&method=addblock\'">
                                新增设置 <i class="fa fa-plus"></i>
                            </button>
                            <div class="tools">
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
                                <tr>
                                    ...
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['chapterid'].'
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['chaptername'].'
                                    </td>
                                    <td>
                                        <a href="'.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['blockpic'].'" target="_blank">查看</a> <a href="index.php?controller=article&method=delblock&delid='.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['articleid'].'" onclick="return confirm(\'确认删除吗？\');">删除</a>
                                    </td>
                                </tr>
                                ';
}
