                        ...
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <form action="" method="post">
                                    <table width="100%">
                                        <tr>
                                            <td><input class="form-control form-control-inline input-small date-picker" size="10" type="text" name="fromtime" value="'.$this->_tpl_vars['fromtime'].'" onclick="laydate()" /></td>
                                            <td>-</td>
                                            <td><input class="form-control form-control-inline input-small date-picker" size="10" type="text" name="totime" value="'.$this->_tpl_vars['totime'].'" onclick="laydate()" /></td>
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
                                <tr>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['articleid'].'
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['articlename'].'
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['regcount'].'
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['paycount'].'
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['payx'].'%
                                    </td>
                                    <td>
                                        '.$this->_tpl_vars['rows'][$this->_tpl_vars['i']['key']]['paymoney'].'
                                    </td>
                                </tr>
                                ';
}
