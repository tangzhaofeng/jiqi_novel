...
echo '>
  ...
  <tr>
    ...
    <td align="left" valign="middle">100000</td>
     ...
     <p class="dwntxt clearfix">每充值1元获得100点VIP成长值<a href="'.geturl('3g','pay').'" class="btn0 btnorg">充值</a></p>
    </span><!--txtbox end-->
    ...
    <span class="txtabox m12">
     ...
     <p class="dwntxt clearfix">查看等级特权详情，请访问爱书坊主站 www.ishufun.net></p>
    </span><!--txtbox end-->
   </div><!--firstdiv end-->
