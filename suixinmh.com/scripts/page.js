...
{   //var cntUrl = base64encode(window.location.href);
	...
	msg +=("     你也可以用站外账号登录:");
	msg +=("     <p class=\"o_login pt10\"><a href=\"javascript:;\" onclick=\"otherlogin(\'\/qqlogin\');\" title=\"腾讯QQ\" class=\"qq\"></a><!--<a href=\"javascript:;\" title=\"新浪微博\" onclick=\"alert(\'即将推送，敬请期待！\');\" class=\"sina\"></a>--></p>");
	msg +=("    </div>");
	msg +=("    </div><!--logn end-->");
	var i = $.layer({
		type : 1,
