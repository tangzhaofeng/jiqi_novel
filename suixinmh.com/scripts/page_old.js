...
function loadheader(vip)
{
	if(getUserId()>0)
	{
		try{
			if(vip){
				var gurl = urlParams(HOST_URL+"login/viplogined", 'ajax_request=1');//method=viplogined&
			}else{
...
{   //var cntUrl = base64encode(window.location.href);
	...
	msg +=("         <img src=\"/checkcode.php\" width=\"90\" height=\"35\" class=\"pic\" id=\"checkcode3\" /><a class=\"f_org2 pl10\" id=\"recode3\" onclick=\"$(\'#checkcode3\').attr(\'src\',\'"+HOST_URL+"/checkcode.php?rand=\'+Math.random());\">换一张</a>");
