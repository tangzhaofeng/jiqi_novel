...
$jieqiLang['system']['reset_password']='%s重设密码 ';
$jieqiLang['system']['get_password_link']='亲爱的用户 %s: 您好!<br><br>&nbsp;&nbsp;&nbsp;&nbsp;您收到这封电子邮件是因为您 (也可能是某人冒充您的名义) 申请了一个新的密码。假如这不是您本人所申请, 请不用理会这封电子邮件, 但是如果您持续收到这类的信件骚扰, 请您尽快联络管理员。<br><br>&nbsp;&nbsp;&nbsp;&nbsp;要使用新的密码, 请使用以下链接<a href="%s" target="_blank">找回密码请点击此链接</a>启用密码。<br><br>关注正版文学，请访问'.JIEQI_SITE_NAME.'：'.JIEQI_LOCAL_URL.'<br><br>我们将一如既往、热忱的为您服务！';
...
$jieqiLang['system']['not_email']='对不起，该Email不存在';
$jieqiLang['system']['get_back_password']='取回密码';
$jieqiLang['system']['email_send_failure']='对不起，邮件发送失败！<br />%s';
$jieqiLang['system']['get_password_code']='亲爱的用户 %s: 您好!<br><br>&nbsp;&nbsp;&nbsp;&nbsp;您收到这封电子邮件是因为您 (也可能是某人冒充您的名义) 申请了一个新的密码。假如这不是您本人所申请, 请不用理会这封电子邮件, 但是如果您持续收到这类的信件骚扰, 请您尽快联络管理员。<br><br>&nbsp;&nbsp;&nbsp;&nbsp;要使用新的密码, 请输入以下验证码：%s。<br><br>&nbsp;&nbsp;&nbsp;&nbsp;关注正版文学，请访问'.JIEQI_SITE_NAME.'：'.JIEQI_LOCAL_URL.'<br><br>&nbsp;&nbsp;&nbsp;&nbsp;我们将一如既往、热忱的为您服务！';
...
$jieqiLang['system']['register_success']='恭喜您 %s，您已成功注册成为本站用户！';
...
$jieqiLang['system']['error_user_format']='用户名由2-30位数字、汉字、字母、下划线、小数点、@符号组成';//'用户名不能有空格及特殊字符！';
...
$jieqiLang['system']['user_edit']='用户资料修改';
...
$jieqiLang['system']['register_user_length']='用户名为1-30个字符,允许由中文,数字,英文,下划线,小数点,@符组成';
$jieqiLang['system']['register_checkbox']='请阅读书海阅读协议';
...
$jieqiLang['system']['userlog_less_vipscore']='减少VIP积分：%d；';
$jieqiLang['system']['userlog_add_vipscore']='增加VIP积分：%d；';
...
$jieqiLang['system']['table_users_isvip']='VIP积分';
