...
if(is_file('global.php')) require_once('global.php');
...
if(isset($_GET['template'])) $_GET['template'] = htmlspecialchars(addcslashes(str_replace(array('/','\'','"','.','http:','ftp:'),'',$_GET['template'])))
