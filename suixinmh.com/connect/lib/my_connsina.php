 ...
 * @version 1.0
 */
class MyConnsina extends JieqiObject
{
	/**
	 * 构造函数
	 * 
	...
	{
		$this->oauth = new SaeTOAuthV2( '3898936498', '683045b98ddccf98ed0f76fffbee62be', '2.00oFnBcFYUXrPE028558921dB_LWdD',  NULL );
	}
	 ...
	 * @return array
	 */
	function show_user_by_id( $params)
	{  
		$uid  = $params['uid'];
		if ( $uid !== NULL ) {
			$this->id_format($uid);
