...
$to = implode(',',$this->to);
$headers = "From: $from{$maildelimiter}MIME-Version: 1.0{$maildelimiter}Content-type: text/html; charset=".$this->params['charset']."{$maildelimiter}Content-Transfer-Encoding: base64{$maildelimiter}";
