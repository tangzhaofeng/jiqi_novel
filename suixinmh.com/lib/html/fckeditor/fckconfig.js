...
FCKConfig.Uploadfile = window.parent.SiteUrl + 'attachment.php?action=upload&module=' + FCKConfig.Module + '&catid=' + window.parent.catid + '&from=fckeditor&uploadtext='+FCKConfig.MM_objid;
...
FCKConfig.ToolbarSets["default"] = [
	...
	['Link','Unlink','Anchor'],
	['Image','Attach','Flash','Media','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey','RemoteUpload'],
...
FCKConfig.ToolbarSets["full"] = [
	...
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Link','Unlink','Anchor'],
	['Image','Attach','Flash','Media','Table','Rule','Smiley','SpecialChar','PageBreak','RemoteUpload'],
	['OrderedList','UnorderedList','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Form','Checkbox','Radio','TextField','Textarea','Select','Button','ImageButton','HiddenField'],
	'/',
	['Style','FontFormat','FontName','FontSize'],
...
FCKConfig.ToolbarSets["standard"] = [
	['Source','Paste','PasteText','PasteWord','-','Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','TextColor','Table','-','JustifyLeft','JustifyCenter','JustifyRight','OrderedList','UnorderedList','-','Image','Attach','Flash','Media','RemoteUpload'],
...
FCKConfig.ToolbarSets["introduce"] = [
	['Source','Bold','Italic','TextColor','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','Attach','Flash','Media','RemoteUpload']
] ;
