...
{
return ($this->block[1]==73 &&
$this->block[2]==68 &&
$this->block[3]==51);
}
protected function startswithpk()
{
return ($this->block[1]==80 &&
$this->block[2]==75);
}
...
$whichcolumn=0;
else if (mp3file::is_mpeg10($mp3) &&mp3file::is_layer2($mp3) )
$whichcolumn=1;
else if (mp3file::is_mpeg10($mp3) &&mp3file::is_layer3($mp3) )
$whichcolumn=2;
else if (mp3file::is_mpeg20or25($mp3) &&mp3file::is_layer1($mp3) )
$whichcolumn=3;
